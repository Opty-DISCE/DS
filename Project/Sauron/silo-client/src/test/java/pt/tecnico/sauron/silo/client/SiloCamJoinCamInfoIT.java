...
public class SiloCamJoinCamInfoIT extends BaseIT {
  ...
  public void RegisterCameraNoCamera() {
    assertEquals(
        ...
        Assertions.assertThrows(
                StatusRuntimeException.class,
                () -> frontend.cam_join(CamJoinRequest.getDefaultInstance()))
            .getStatus()
            .getCode());
  }
  ...
  public void CamInfoOfRegisteredCamera() {
    ...
    CamInfoResponse response =
        frontend.cam_info(CamInfoRequest.newBuilder().setName("cam").build());
  ...
  public void CamInfoOfInvalidName2Characters() {
    assertEquals(
        ...
        Assertions.assertThrows(
                StatusRuntimeException.class,
                () -> frontend.cam_info(CamInfoRequest.newBuilder().setName("ca").build()))
            .getStatus()
            .getCode());
  }
  ...
  public void CamInfoOfInvalidName16Characters() {
    assertEquals(
        ...
        Assertions.assertThrows(
                ...
                () ->
                    frontend.cam_info(
                        CamInfoRequest.newBuilder().setName("xxxxxxxxxxxxxxxx").build()))
            .getStatus()
            .getCode());
  }
