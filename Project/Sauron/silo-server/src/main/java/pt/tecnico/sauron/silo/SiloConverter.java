...
public class SiloConverter {
  ...
  public static ObservedObject toDomainObject(Silo.ObservedObject reqObject)
      throws SauronException {
  ...
  public static List<ObservedObject> toDomainObjects(List<Silo.ObservedObject> reqObjects)
      throws SauronException {
  ...
  public static Observation toDomainObservation(Silo.Observation reqObservation)
      throws SauronException {
  ...
  public static List<Observation> toDomainObservations(List<Silo.Observation> reqObservations)
      throws SauronException {
  ...
  public static Silo.ObservedObject toSiloObject(ObservedObject object) throws SauronException {
    ...
    switch (object.getType()) {
      ...
      case CAR:
        Car car = (Car) object;
        return Silo.ObservedObject.newBuilder().setType(Silo.Type.CAR).setId(car.getId()).build();
      default:
        throw new SauronException(INVALID_ARGUMENT, INVALID_TYPE, "UNKNOWN");
    }
  }

  public static List<Silo.ObservedObject> toSiloObjects(List<ObservedObject> objects)
      throws SauronException {
  ...
  public static Silo.Observation toSiloObservation(Observation observation) throws SauronException {
    ...
    Timestamp resTimestamp = Timestamp.newBuilder().setSeconds(observation.getSeconds()).build();
  ...
  public static List<Silo.Observation> toSiloObservations(List<Observation> observations)
      throws SauronException {
  ...
  public static List<Silo.Entry> toSiloVecTS(VecTimestamp prevTS) {
    ...
    while (prevTS.hasNext()) {
      ...
      vecTS.add(Silo.Entry.newBuilder().setKey(entry.getKey()).setValue(entry.getValue()).build());
    }
    return vecTS;
  }
  ...
  public static Update toDomainUpdate(Silo.Update update) throws SauronException {
    ...
    if (update.hasCamJoin())
      return toDomainCamJoin(update.getID(), update.getPrevTSList(), update.getCamJoin());
    if (update.hasReport())
      return toDomainReport(update.getID(), update.getPrevTSList(), update.getReport());
    throw new SauronException(INVALID_ARGUMENT, INVALID_TYPE, "UNKNOWN");
  }
  ...
  public static CamJoinUpdate toDomainCamJoin(
      Integer ID, List<Silo.Entry> prevTS, Silo.CamJoinRequest request) throws SauronException {

    Camera camera = toDomainCamera(request.getCamera());
    return new CamJoinUpdate(ID, toDomainVecTS(prevTS), camera);
  }

  public static ReportUpdate toDomainReport(
      Integer ID, List<Silo.Entry> prevTS, Silo.ReportRequest request) throws SauronException {
    ...
    return new ReportUpdate(
        ID, toDomainVecTS(prevTS), camName, objects, request.getTs().getSeconds());
  }
  ...
  public static Silo.Update toSiloUpdate(Update update) throws SauronException {
    ...
    Silo.Update.Builder reqUpdate =
        Silo.Update.newBuilder()
            .setID(update.getID())
